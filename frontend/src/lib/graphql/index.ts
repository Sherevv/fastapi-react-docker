...
const dataProvider = (client: GraphQLClient): DataProvider => {
    return {
        ...
        create: async ({ resource, variables, metaData }) => {
            ...
            const pascalCreateName = camelCase(camelCreateName, {pascalCase: true});
        ...
        update: async ({ resource, id, variables, metaData }) => {
            ...
            const pascalUpdateName = camelCase(camelUpdateName, {pascalCase: true});
        ...
        deleteOne: async ({ resource, id, metaData }) => {
            ...
            const pascalDeleteName = camelCase(camelDeleteName, {pascalCase: true});
